...
describe('notifications', () => {
  ...
  describe('notificationsActions', () => {
    it('addNotification should create correct action', () => {
      ...
      expect(notificationsActions.addNotification('message', 'variant')).toEqual(expectedAction);
    });
  ...
  describe('notificationsSelectors', () => {
    ...
    it('getMessageNotification should return message', () => {
      expect(notificationsSelectors.getMessageNotification(state)).toEqual('message');
    });
    it('getVariantNotification should return variant', () => {
      expect(notificationsSelectors.getVariantNotification(state)).toEqual('variant');
    });
  });
